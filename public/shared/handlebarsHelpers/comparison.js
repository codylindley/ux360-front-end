define(function (require) {
	...
	//find docs for this here: http://assemble.io/helpers/helpers-comparison.html
	...
	var helpers = {
		 ...
		 *   {{/compare}}
		 */
		compare: function (left, operator, right, options) { /*jshint eqeqeq: false*/
	...
	for (var helper in helpers) {
		if (helpers.hasOwnProperty(helper)) {
			handlebars['default'].registerHelper(helper, helpers[helper]);
		}
	}
